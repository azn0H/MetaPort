    ...
    >
      <div>
        <div className="flex items-start justify-between gap-3 mb-3">
          <div className="flex items-center gap-3.5">
            <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${link.gradient} flex items-center justify-center shadow-lg flex-shrink-0`}>
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-xs text-cyan-400/80 hover:text-cyan-300 flex items-center gap-1 mt-0.5 break-all"
              >
                <span>{link.url}</span>
      ...
      <div className="flex items-center justify-between pt-3 border-t border-slate-800/60 text-xs">
        ...
        >
          ...
          <span>{link.is_active ? 'Viditelný' : 'Skrytý'}</span>
        </button>
