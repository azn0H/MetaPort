...
export function MetricCardSkeleton() {
  return (
    <div className="rounded-2xl bg-[#121215] border border-zinc-800/80 p-5 space-y-4">
...
export function ProjectCardSkeleton() {
  return (
    <div className="rounded-2xl bg-[#121215] border border-zinc-800/80 p-6 space-y-4">
      <div className="flex justify-between items-start">
        <div className="flex items-center gap-3">
          <Skeleton className="w-10 h-10 rounded-xl" />
          <div className="space-y-1.5">
...
export function PortalLinkSkeleton() {
  return (
    <div className="rounded-2xl bg-[#121215] border border-zinc-800/80 p-5 space-y-3">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="rounded-2xl bg-[#121215] border border-zinc-800/80 p-6 space-y-6">
